...
与 [67 批量 Embedding](67.embedding-batching-tutorial.md) 一致：夜间 job 用大 `batch_size`，失败行写入 **死信队列** 单独重试，避免整批重跑。
...
**Q：与 [68 Embedding 缓存](68.embedding-cache-tutorial.md) 的关系？**  
