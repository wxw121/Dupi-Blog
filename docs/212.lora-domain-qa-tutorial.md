...
成本主要来自训练 GPU、数据清洗、人审和上线回归。对多数企业 RAG，LoRA 不是第一阶段任务。先把 [151 检索遗漏](151.bad-case-retrieval-miss-tutorial.md)、[152 幻觉坏例](152.bad-case-hallucination-tutorial.md)、[141 RAGAS Faithfulness](141.ragas-faithfulness-tutorial.md) 做稳，再考虑微调。
