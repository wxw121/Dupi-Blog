...
| [流式 UI 15](15.streaming-ui-rendering-tutorial（front-end）.md) | 流式阶段纯文本 vs 结束后 Markdown |
...
[流式 UI 篇](15.streaming-ui-rendering-tutorial（front-end）.md) 已述：流式过程中 **每 chunk 全量 Markdown 解析** 既费性能，也可能因**未闭合标记**导致 DOM 结构抖动。安全上还有一层：
...
| 流式时机 | [15：流式 UI](15.streaming-ui-rendering-tutorial（front-end）.md) |
