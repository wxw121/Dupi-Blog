...
| [前端状态管理](14.frontend-state-management-tutorial（front-end）.md) | 多会话 `messages` 是否进全局 Store |
...
**Q：流式内容要不要进 Zustand？**
A：单页聊天 `useState` 够；多 Tab 会话、跨路由恢复再考虑全局 Store，见 [状态管理篇](14.frontend-state-management-tutorial（front-end）.md)。
