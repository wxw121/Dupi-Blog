...
![静态类型与动态类型：两套检查各管什么时候](../image/typescript-basics/01-static-check-pipeline.png)
...
![综合概念地图：本章名词一览](../image/typescript-basics/02-concept-map.png)
...
![决策树：何时上 TypeScript](../image/typescript-basics/03-decision-tree.png)
