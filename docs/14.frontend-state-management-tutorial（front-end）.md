...
![先分清两类状态：客户端 vs 服务端](../image/frontend-state-management/01-client-vs-server-state.png)
...
![单向数据流：Redux 核心叙事](../image/frontend-state-management/02-unidirectional-data-flow.png)
...
![Zustand / Redux / Pinia 选型决策树](../image/frontend-state-management/03-selection-decision-tree.png)
